...
This repository implements a simple controller for watching Argocdprogs resources as
...
* `pkg/apis/knapps/v1alpha1/zz_generated.deepcopy.go`
* `pkg/generated/`
...
The argocdprogs controller uses [client-go library](https://github.com/kubernetes/client-go/tree/master/tools/cache) extensively.
...
# check argocdprogs for their status
